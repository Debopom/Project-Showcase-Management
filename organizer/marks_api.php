                            ...
                            <table class="table" align="center" style="width:90%; line-height:200%;">
                                ...
                                <tbody>
                                    ...
                                    while ($rows = mysqli_fetch_array($rs)) {
                                        ...
                                        $sql1 = "SELECT p.*,g.group_name,g.group_category FROM projects AS p JOIN groups AS g on (p.group_id=g.group_id) WHERE project_id = $project_id GROUP BY p.marks DESC";
                                        $rs1 = $conn->query($sql1);
