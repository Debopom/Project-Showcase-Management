...
if(isset($_POST['input'])){
    ...
    //  $query = "SELECT project_id,project_title,description,category FROM projects WHERE category LIKE '{$input}%'";
     $query = "SELECT student.student_id, student.name,projects.project_title,projects.description, groups.group_category
     FROM student
     JOIN groups
     ON groups.student_id=student.student_id
     JOIN projects
     ON projects.group_id=student.student_id
