...
<body>
    ...
    <div class="container">
        ...
        <input id="phone"type="text" placeholder="Enter Phone Number...."required> <br><br>
        <!-- <input id="email"type="email" placeholder="Enter Email...."required> <br><br> -->
        ...
        <select id="role" name="role">
            <option value="CSE">Organizer</option>
            <option value="EEE">Judge</option>
            <option value="BBA">Faculty</option>
...
<!-- JavaScript Bundle with Popper -->
    ...
    <script src="organizer_ajax.js"></script>
</body>
</html>